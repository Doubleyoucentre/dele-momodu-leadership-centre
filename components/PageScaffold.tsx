...
export function PageScaffold({ data, applyCta = false }: { data: PageData; applyCta?: boolean }) {
  return (
    <main id="main-content" className="bg-[#f7f3eb]">
      ...
      <Reveal image className="relative h-[clamp(380px,58vw,760px)] bg-[#d8d1c4]"><Image src={data.image} alt={data.imageAlt} fill priority sizes="100vw" className="object-cover object-center" /></Reveal>
